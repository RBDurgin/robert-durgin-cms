...
const SocialLinks = () => (
  <div className="column is-4 social">
    <a title="github" href="https://github.com/RBDurgin/">
      <FontAwesomeIcon icon={faGithub} color="black" style={{ width: '1em', height: '1em' }} />
    </a>
    <a title="stack-overflow" href="https://stackoverflow.com/users/3132/robert-durgin">
      <FontAwesomeIcon icon={faStackOverflow} color="black" style={{ width: '1em', height: '1em' }} />
    </a>
    <a title="linkedin" href="https://www.linkedin.com/in/robert.durgin">
